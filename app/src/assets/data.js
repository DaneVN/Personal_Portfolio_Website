const frontEndProjects = [
  ...
  },
  {
    ...
    desc: `A mobile-based webpage that helps agents keep track of all their monthly activities, 
    and provide stats on the data collected in the current and previous month`,
