...
const FrontEndPage = () => {
  return (
    <div className="bg-[var(--clf-offWhite)] text-[var(--clb-darkest)]">
      ...
      <section className="py-4 p-1 bg-[var(--clb-darker)] text-[var(--clb-lighter)]">
        <div>
      ...
      {/* section 2: Skills */}
      <section className="py-4 p-1 bg-[var(--clb-accent)]">
        <div>
      ...
      <section className="py-4 p-1 bg-[var(--clb-lightest)]">
        <div>
